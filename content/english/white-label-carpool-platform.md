...
banner:
  ...
  title: "A White-Label Carpool Platform — Your Brand, Live in Days"
  description: "Launch a branded employee carpool platform without hiring an app-development agency. TeamWheels runs as a white-label experience inside your own Microsoft 365 tenant: your name, your policies, your data — deployed from AppSource in about 5 minutes."
  button:
    enable: true
...
image_and_content_blocks:
  - enable: true
    anchor: "deploy-dont-build"
    subtitle: "Deploy, Don't Build"
    title: "A White-Label Carpool App Without the Development Project"
    image: "images/carpooling_kpis.png"
    content_position: "right"
    content: "Search for a white-label carpool app and you'll mostly find development agencies and clone scripts: 14–16 weeks of build time, $20,000–$200,000+ budgets, and an app your employees still have to download. That path makes sense if you're launching a consumer rideshare business. It rarely makes sense for an employer.

    TeamWheels is the other path — a ready-to-run corporate carpool platform you brand and configure instead of build:

    * **Live in days, not quarters** — Install from Microsoft AppSource in about 5 minutes; brand and configure in an afternoon

    * **No code, no maintenance** — No developers to hire, no app-store releases to manage, no servers to run
  ...
  - enable: true
    ...
    * **Employers & HR teams** — Offer a branded commute benefit that cuts parking demand by up to 30% and saves employees $2,000+/year

    * **Sustainability & ESG teams** — Turn commuting into measurable Scope 3 reductions with audit-ready data

    * **Campuses, hospitals & business parks** — Run one carpool program across multiple organizations and sites

    * **Mobility managers** — Replace spreadsheets and stalled standalone apps with a platform employees actually open

    If instead you're a startup building a consumer rideshare product to resell, you're looking for an app-development kit — that's not TeamWheels. For everyone running an employee program: [compare pricing →](/en/pricing/) or see the full [corporate carpooling software platform →](/en/corporate-carpooling-software/)
    "
    button:
      enable: false
...
howto:
  name: "Launch a White-Label Corporate Carpool Platform"
  description: "How to deploy a branded, HR-integrated employee carpool platform in days using white-label SaaS instead of custom development."
  totalTime: "P14D"
  tool:
    - "Microsoft Teams"
    - "TeamWheels"
...
call_to_action:
  enable: true
  title: "Launch Your Branded Carpool Platform This Week"
  subtitle: "Book a personalized demo and start a free 30-day trial — your brand, your tenant, live in days. <br><br> <strong>5-minute setup.</strong> No credit card, no development project, no separate app for employees."
