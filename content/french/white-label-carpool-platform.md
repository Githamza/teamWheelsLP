...
banner:
  ...
  title: "Une Plateforme de Covoiturage en Marque Blanche — À Votre Marque, en Quelques Jours"
  description: "Lancez une plateforme de covoiturage salariés à votre marque, sans agence de développement. TeamWheels se déploie en marque blanche dans votre propre tenant Microsoft 365 : votre nom, vos règles, vos données — installé depuis AppSource en 5 minutes environ."
  button:
    enable: true
...
image_and_content_blocks:
  - enable: true
    anchor: "deployer-pas-developper"
    subtitle: "Déployer, pas développer"
    title: "Une App de Covoiturage en Marque Blanche, Sans Projet de Développement"
    image: "images/carpooling_kpis.png"
    content_position: "right"
    content: "Cherchez « application de covoiturage en marque blanche » et vous trouverez surtout des agences de développement et des scripts clonés : 14 à 16 semaines de réalisation, 20 000 à 200 000 €+ de budget, et une app que vos salariés devront quand même télécharger. Cette voie a du sens pour lancer un service de covoiturage grand public. Rarement pour un employeur.

    TeamWheels, c'est l'autre voie — une plateforme de covoiturage entreprise prête à l'emploi, que vous personnalisez au lieu de la construire :

    * **Opérationnelle en jours, pas en trimestres** — Installation depuis Microsoft AppSource en 5 minutes environ ; personnalisation en une après-midi

    * **Zéro code, zéro maintenance** — Pas de développeurs à recruter, pas de mises à jour d'app stores, pas de serveurs à gérer
  ...
  - enable: true
    ...
    * **Employeurs & équipes RH** — Offrez un avantage mobilité à votre marque : jusqu'à 30 % de besoin en parking en moins et des économies réelles pour les salariés

    * **Équipes RSE** — Transformez le domicile-travail en réductions Scope 3 mesurables, avec des données prêtes pour l'audit

    * **Campus, hôpitaux & zones d'activité** — Un seul programme de covoiturage pour plusieurs organisations et sites

    * **Responsables mobilité** — Remplacez les tableurs et les apps autonomes à l'abandon par une plateforme que les salariés ouvrent vraiment

    Si vous êtes une startup qui veut construire un produit de covoiturage grand public à revendre, il vous faut un kit de développement — ce n'est pas TeamWheels. Pour tous ceux qui gèrent un programme salariés : [comparez les tarifs →](/fr/pricing/) ou découvrez le [logiciel de covoiturage entreprise complet →](/fr/corporate-carpooling-software/)
    "
    button:
      enable: false
...
howto:
  name: "Lancer une plateforme de covoiturage entreprise en marque blanche"
  description: "Comment déployer en quelques jours une plateforme de covoiturage salariés à votre marque, intégrée RH, avec un SaaS en marque blanche plutôt qu'un développement sur mesure."
  totalTime: "P14D"
  tool:
    - "Microsoft Teams"
    - "TeamWheels"
...
call_to_action:
  enable: true
  title: "Lancez votre plateforme de covoiturage à votre marque cette semaine"
  subtitle: "Demandez une démo personnalisée et démarrez un essai gratuit de 30 jours — votre marque, votre tenant, opérationnel en quelques jours. <br><br> <strong>Installation en 5 minutes.</strong> Sans carte bancaire, sans projet de développement, sans app séparée pour les salariés."
